...
系统 SHALL 提供一个基于 React + TypeScript 的前端应用，能够通过 HTTP 访问。
...
系统 SHALL 提供位置管理功能的用户界面，支持增删改查操作。

#### Scenario: List locations
- **WHEN** user navigates to the location management page
- **THEN** system displays a list of all locations
...
系统 SHALL 提供房间管理功能的用户界面，支持增删改查操作。

#### Scenario: List rooms
- **WHEN** user navigates to the room management page
- **THEN** system displays a list of all rooms
...
系统 SHALL 提供房东管理功能的用户界面，支持增删改查操作。

#### Scenario: List landlords
- **WHEN** user navigates to the landlord management page
- **THEN** system displays a list of all landlords
...
系统 SHALL 提供租约管理功能的用户界面，支持增删改查、续租、退租操作。

#### Scenario: List leases
- **WHEN** user navigates to the lease management page
- **THEN** system displays a list of all leases
...
系统 SHALL 提供账单管理功能的用户界面，支持增删改查和打印收据操作。

#### Scenario: List bills
- **WHEN** user navigates to the bill management page
- **THEN** system displays a list of all bills
...
系统 SHALL 提供打印功能的用户界面，支持打印账单、租约、发票。

...
- [ ] 6.1 重构 CQRSLandlordHandler 直接使用总线
- [ ] 6.2 重构 CQRSLeaseHandler 直接使用总线
- [ ] 6.3 重构 CQRSBillHandler 直接使用总线
- [ ] 6.4 为重构后的 HTTP 处理器编写集成测试

## 7. 清理和优化

- [ ] 7.1 将未使用的传统服务标记为 deprecated
- [ ] 7.2 移除 internal/application/service/landlord.go
- [ ] 7.3 移除 internal/application/service/lease.go
- [ ] 7.4 移除 internal/application/service/bill.go
- [ ] 7.5 移除 internal/application/service/deposit.go
...
- [ ] 9.1 更新 internal/application/cqrs/README.md
- [ ] 9.2 为查询总线添加文档
- [ ] 9.3 为事件总线添加文档
- [ ] 9.4 运行所有测试确保通过
- [ ] 9.5 进行端到端测试
